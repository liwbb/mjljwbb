	...
	<%@ include file="tfbody.jsp"%>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title btn-danger h31">会员修改失败请重新输入</h3>
					<h3 class="panel-title btn-success h32">会员修改</h3>
					<h3 type="hidden" id="flag" data="${param.id }"
						class="panel-title btn-success h32"></h3>
				</div>
				<div class="panel-body">
					<form id="signupForm" method="post" class="form-horizontal"
						action="/myjsp3/cardmodify" novalidate="novalidate">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="name" name="name"
									placeholder="${list.name }" value="${list.name }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="tel"
									name="tel" placeholder="${list.tel }" value="${list.tel }">
							</div>
						</div>
