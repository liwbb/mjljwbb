	...
	<%@ include file="tfbody.jsp"%>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title btn-danger h31">图书添加失败请重新输入</h3>
					<h3 class="panel-title btn-success h32">图书添加</h3>
					<h3 type="hidden" id="flag" data="${'404'==param.id }"
						class="panel-title btn-success h32"></h3>
				</div>
				<div class="panel-body">
					<form id="signupForm" method="post" class="form-horizontal"
						action="/myjsp3/bookaddtj" novalidate="novalidate">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="author"
									name="author" placeholder="请输入作者" value="">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="publishing"
									name="publishing" placeholder="请输入出版社" value="">
							</div>
						</div>
						<div class="form-group">
