						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="code" name="code"
									placeholder="${borrow.bid }" value="${borrow.code }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="title" name="title"
									placeholder="${borrow.title }" value="${book.title }">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="publishing"
									name="publishing" placeholder="${book.publishing }" value="${book.publishing }">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="total" name="total"
									placeholder="${book.total }" value="${book.total }">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" id="count"  name="count"
									...
									placeholder="${book.count }" value="${book.count }">
							</div>
						</div>
